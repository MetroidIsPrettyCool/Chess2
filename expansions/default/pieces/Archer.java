...
public class Archer extends Piece  {
	...
	super(px, py, 1, "archer", "Archer", "Compound bows are for pussies", "Can move horizontally like a castle", "But captures up to 3 spaces vertically", pcolor);
    }
    @Override
    public int [] [] getPossibleMoves (Board board)  {
        int [] [] moves = new int [GameSettings.BOARDSIZE] [GameSettings.BOARDSIZE];
	if (this.getX() - 1 >= 0 && board.board [this.getX() - 1] [this.getY()].getName().equals(""))  moves [this.getX() - 1] [this.getY()] = 1;
